...
__decorate([
    ...
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsArray)({ message: 'O campo vmsIds deve ser um array' }),
    (0, class_validator_1.IsInt)({ each: true, message: 'Cada ID de VM deve ser um número inteiro' }),
    __metadata("design:type", Array)
], CreateAssetDto.prototype, "vmsIds", void 0);
