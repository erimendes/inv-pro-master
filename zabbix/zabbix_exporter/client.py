...
class ZabbixClient:
    ...
    def get_hosts(self):
        """Retrieves all hosts with items filtered for CPU, RAM, OS and Storage."""
        ...
        payload = {
            ...
            "params": {
                ...
                # ADICIONADO "system": Permite capturar chaves nativas do Windows Agent
                "selectItems": ["itemid", "name", "key_", "lastvalue", "units"],
                "searchItems": {
                    "key_": ["cpu", "memory", "uptime", "vfs.fs", "total", "storage", "os", "wmi", "sw.os", "system"]
                },
                "searchByAny": True,
