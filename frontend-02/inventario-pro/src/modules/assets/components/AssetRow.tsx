...
export const AssetRow: React.FC<AssetRowProps> = ({ 
  ...
  return (
    <div className="border-b border-white/5 last:border-none">
      <button onClick={onToggle} className="w-full px-6 py-5 text-left transition hover:bg-white/5">
      ...
      {isOpen && (
        <div className="border-t border-white/5 bg-black/20 px-6 py-5">
          <div className="mb-5 grid grid-cols-1 gap-4 md:grid-cols-3">
            <InfoCard label="IP" value={asset.ipPrincipal} />
            <InfoCard label="Sistema" value={asset.sistemaOperacional} />
