...
export function RackActionDrawer({ rackName, onClose, onView, onEdit }: Props) {
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[100] flex items-center justify-center p-4">
      <div className="bg-slate-900 border border-white/10 w-full max-w-md rounded-3xl p-8 shadow-2xl">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-xl font-bold text-white italic">RACK: {rackName}</h2>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          >
            ...
            <span className="font-bold text-emerald-400">Editar Layout</span>
          </button>
        </div>
      </div>
    </div>
